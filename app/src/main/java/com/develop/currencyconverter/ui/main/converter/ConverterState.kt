...
data class ConverterState(
    ...
    val currencyDropdownSelectedState: MutableState<Int> = mutableStateOf(CurrencyDropdownState.NONE),
)
...
fun rememberConverterState(
    ...
    currencyDropdownSelectedState: MutableState<Int> = remember { mutableStateOf(CurrencyDropdownState.NONE) },
